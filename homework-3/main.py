...
if __name__ == '__main__':
    ...
    moscowpython = Channel('UC-OVMPlMA3-YCIeg4z5z23A', "AIzaSyAuL2OjFeSiPj6_RbqicyelyX0pmeDkboA")
    highload = Channel('UCwHL6WHUarjGfUM_586me8w', "AIzaSyAuL2OjFeSiPj6_RbqicyelyX0pmeDkboA")
